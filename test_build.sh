...
export CROSS_COMPILE=$PARENT_DIR/Clang-19.0.0/bin/aarch64-linux-gnu-
export CC=$PARENT_DIR/Clang-19.0.0/bin/clang

export PLATFORM_VERSION=12
export ANDROID_MAJOR_VERSION=s
export PATH=$PARENT_DIR/Clang-19.0.0/bin:$PATH
